...
def test_check_title(logged_in_page): 
...
def test_check_label_accountname(logged_in_page):
    logged_in_page.get_by_role("button", name="新規追加").click()
...
def test_check_field_accountname(logged_in_page):
    logged_in_page.get_by_role("button", name="新規追加").click()
...
def test_check_label_mail(logged_in_page):
    logged_in_page.get_by_role("button", name="新規追加").click()
    label = logged_in_page.locator(".label-title", has_text="メールアドレス")
    expect(label).to_be_visible()
    expect(label.locator(".required-mark",has_text="*")).to_be_visible()
    
def test_check_field_mail(logged_in_page):
    logged_in_page.get_by_role("button", name="新規追加").click()
...
def test_check_label_password(logged_in_page):
    logged_in_page.get_by_role("button", name="新規追加").click()
...
def test_check_field_password(logged_in_page):
    logged_in_page.get_by_role("button", name="新規追加").click()
...
def test_check_authority_case10 (logged_in_page):
    logged_in_page.get_by_role("button", name="新規追加").click()
...
def test_check_authority_case11 (logged_in_page):
    logged_in_page.get_by_role("button", name="新規追加").click()
    authority_section = logged_in_page.locator(".label-input", has_text="権限")
...
def test_check_authority_case12 (logged_in_page):
    logged_in_page.get_by_role("button", name="新規追加").click()
    authority_section = logged_in_page.locator(".label-input", has_text="権限")
    authority_section.locator(".multiselect-wrapper").click()
